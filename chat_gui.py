...
class ChatGUI:
    ...
    def add_image_message(self, sender_ip, image_b64, image_name, timestamp):
        try:
            ...
            self.add_message(f"Error displaying image: {e}", 'red')
    ...
    def handle_server_message(self, data):
        ...
        if msg_type == 'message':
            ...
            self.add_image_message(sender_ip, image_b64, image_name, timestamp)
